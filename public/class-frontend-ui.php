...
class TSB_Frontend_UI {
    ...
    public function enqueue_assets() {
        ...
        // Add jQuery UI CSS for the Datepicker
        ...
        // Add jquery-ui-datepicker dependency
        wp_enqueue_script( 'tsb-form-js', TSB_PLUGIN_URL . 'public/js/tsb-form.js', array( 'jquery', 'tsb-core-js', 'jquery-ui-datepicker' ), '2.6', true );
    ...
    public function render_ui() {
        ...
        // Stats Calculation (FIXED: Pending only counts 'Pending')
    ...
    public static function get_trade_row_html($row) {
        ...
        $dis_upside = ($is_pend || $sl_hit) ? 'disabled style="opacity:0.4; pointer-events:none;"' : '';
        ...
        if($sl_hit) { $btn_t1_dis='disabled style="opacity:0.4;"'; $btn_t2_dis=$btn_t1_dis; $btn_t3_dis=$btn_t1_dis; }
